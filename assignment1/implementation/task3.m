...
image_angle = atan(dimage_x ./ dimage_y);


%% step 3: perform non-maximum suppression

% find principal direction of edges
angle_limits = [-inf -3*pi/8:pi/4:3*pi/8 inf];

[~, angle_directions_full] = histc(image_angle, angle_limits);

% combine the same directions: 1=5=90°, 2=-45°, 3=0°, 4=45°
angle_directions = angle_directions_full;
angle_directions(angle_directions_full == 5) = 1;
...
while 1
    ...
    % eye candy and window manager stress test: show progress of weak edge promotion
